...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-config', type=str, default='/root/.cache/huggingface/hub/models--stabilityai--stable-audio-open-1.0/model_config.json', required=False)
    parser.add_argument('--ckpt-path', type=str, default='/root/.cache/huggingface/hub/models--stabilityai--stable-audio-open-1.0/model.safetensors', required=False)
