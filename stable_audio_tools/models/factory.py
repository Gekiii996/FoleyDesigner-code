...
def create_model_from_config(model_config):
    ...
    #     return create_diffusion_uncond_from_config(model_config)
        ...
        return create_diffusion_cond_from_config(model_config) # final return ConditionedDiffusionModelWrapper
...
def create_pretransform_from_config(pretransform_config, sample_rate):
    ...
    pretransform_type = pretransform_config.get('type', None)   #     "type": "autoencoder",
    ...
    else: raise NotImplementedError(f'Unknown pretransform type: {pretransform_type}')
    
    enable_grad = pretransform_config.get('enable_grad', False) #  False
